...
2. Clone your fork: `git clone https://github.com/mavix21/lantern.git`
3. Navigate to the project directory: `cd lantern`
...
If you have any questions, please [open an issue](https://github.com/mavix21/lantern/issues/new) for discussion.
