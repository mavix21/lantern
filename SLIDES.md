...
_A terminal-based presentation tool built with Node.js, Ink, Yargs, and Bun. Write your slides in Markdown, present them in the terminal. Lantern is heavily inspired by [slides](https://github.com/maaslalani/slides)._
